...
const PaymentSteps = () => {
    ...
    const uploadAndConfirm = () => {
        push("/order-status/121213")
    }

    const hanfleConfirmPayment = async () => {
        if (!file) {
        ...
        if (!customerInfo) {
            alert("Customer information is missing, please teturn to checkout")
            push("/checkout")
            return;
        }
    ...
    return (
        <CardWithHeader title="Payment Steps">
            ...
            <div className="border-t border-gray-200 p-4">
                ...
                <Button variant="dark"  className="w-full mt-4" onClick={hanfleConfirmPayment}>
