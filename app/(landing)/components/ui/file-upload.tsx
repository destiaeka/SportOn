...
type TFielUploadProps = {
    onFileSelect?: (file: File | null) => void;
}

const FileUpload = ({onFileSelect}: TFielUploadProps) => {
    ...
    return (
        ...
        className="flex flex-col justify-center items-center w-full py-6  border border-dashed border-primary bg-primary-light">
            ...
            <div className="text-center my-5">
                ...
                <p className="text-xs"> Upload Your Payment Reciept here</p>
            </div>):(
                <div className="text-center">
                    <FiImage className="text-primary mx-auto"/>
                    <p className="text-sm text-pri">{file.name}</p>
