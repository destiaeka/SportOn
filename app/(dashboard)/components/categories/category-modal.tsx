        ...
        <Modal isOpen={isOpen} onClose={onClose} title={isEditMode ? "Edit Category":"Add New Category"}>
            <form onSubmit={handelSubmit} className="flex flex-col gap-6">
                <div className="flex gap-7"> 
                    <div className="ascpect-square min-w-50">
                    ...
                    <div className="flex flex-col gap-4 w-full">
                        <div className="input-group-admin">
                            ...
                            <Button className="ml-auto mt-3 rounded-lg text-white cursor-pointer" onClick={handelSubmit} disabled={isSubmitting}>{isEditMode ? "Update Category" : "Create Category"}</Button>
                        </div>
                    </div>
                </form>
        </Modal>
